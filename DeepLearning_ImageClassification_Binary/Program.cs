...
namespace DeepLearning_ImageClassification_Binary
{
    class Program
    {
        ...
        static readonly string _predictSingleImage = Path.Combine(_imagesFolder, "mazda-cx-3.jpg");
        ...
        {
            var pipeline = mlContext.Transforms.LoadImages(outputColumnName: "input", imageFolder: _imagesFolder, inputColumnName: nameof(ImageData.ImagePath))
